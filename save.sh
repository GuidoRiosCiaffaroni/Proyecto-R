...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/Proyecto-R.git"
git remote add origin https://github.com/GuidoRiosCiaffaroni/Proyecto-R.git
